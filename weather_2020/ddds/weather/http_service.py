...
def get_data(city,country, unit="metric"):
    url = f"http://api.openweathermap.org/data/2.5/weather?q={city},{country}&units={unit}&APPID=3a33100d38614cfc9876601c363392ba"
    print(url)
    request = Request(url)
...
def temperature():
    ...
    #unit = payload["context"]["facts"]["unit"]["grammar_entry"]
...
def weather():
    ...
    descriptionstr = str(description)
    return query_response(value=descriptionstr, grammar_entry=None)
